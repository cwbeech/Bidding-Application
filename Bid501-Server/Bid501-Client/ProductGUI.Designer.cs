namespace Bid501_Client
{
    partial class ProductGUI
    {
        ...
        private void InitializeComponent()
        {
			...
			this.uxProductName.Size = new System.Drawing.Size(10, 13);
			this.uxProductName.TabIndex = 0;
			this.uxProductName.Text = " ";
			// 
			// uxTimeLeft
			// 
			...
			this.uxTimeLeft.Size = new System.Drawing.Size(10, 13);
			this.uxTimeLeft.TabIndex = 1;
			this.uxTimeLeft.Text = " ";
			// 
			// label3
			// 
			...
			this.uxMinBidAmount.Size = new System.Drawing.Size(10, 13);
			this.uxMinBidAmount.TabIndex = 10;
			this.uxMinBidAmount.Text = " ";
			// 
			// uxDetail
			// 
